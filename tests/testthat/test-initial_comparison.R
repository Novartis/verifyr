...
test_that("Returns 'No changes' for identical files", {
  old_file <- paste0(fs::path_package("/test_outputs/unit_tests/old/","test010_old.rtf", package = "verifyr"))
  new_file <- paste0(fs::path_package("/test_outputs/unit_tests/new/","test01a_new.rtf", package = "verifyr"))
...
test_that("Returns 'Output size has changed' for files with different number of lines", {
  old_file <- paste0(fs::path_package("/test_outputs/unit_tests/old/","test010_old.rtf", package = "verifyr"))
  new_file <- paste0(fs::path_package("/test_outputs/unit_tests/new/","test01b_new.rtf", package = "verifyr"))
...
test_that("Returns 'Only one row has changed' for files with a single different row", {
  old_file <- paste0(fs::path_package("/test_outputs/unit_tests/old/","test010_old.rtf", package = "verifyr"))
  new_file <- paste0(fs::path_package("/test_outputs/unit_tests/new/","test01c_new.rtf", package = "verifyr"))
...
test_that("Returns 'Output has changes in 2 places' for files with multiple different rows", {
  old_file <- paste0(fs::path_package("/test_outputs/unit_tests/old/","test010_old.rtf", package = "verifyr"))
  new_file <- paste0(fs::path_package("/test_outputs/unit_tests/new/","test01d_new.rtf", package = "verifyr"))
...
test_that("Comparison with 'omit' parameter Returns 'No changes'", {
  old_file <- paste0(fs::path_package("/test_outputs/unit_tests/old/","test010_old.rtf", package = "verifyr"))
  new_file <- paste0(fs::path_package("/test_outputs/unit_tests/new/","test01e_new.rtf", package = "verifyr"))
...
test_that("Comparison with 'omit' parameter Returns 'Only one row has changed'", {
  old_file <- paste0(fs::path_package("/test_outputs/unit_tests/old/","test010_old.rtf", package = "verifyr"))
  new_file <- paste0(fs::path_package("/test_outputs/unit_tests/new/","test01f_new.rtf", package = "verifyr"))
